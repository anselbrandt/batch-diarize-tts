...
def create_config(output_dir, audio_path):
    ...
    if not os.path.exists(MODEL_CONFIG_PATH):
        ...
        CONFIG_URL = f"https://raw.githubusercontent.com/NVIDIA/NeMo/refs/heads/main/examples/speaker_tasks/diarization/conf/inference/{CONFIG_FILE_NAME}"
